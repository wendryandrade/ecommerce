...
namespace Ecommerce.Infrastructure.Services
{
    public class CorreiosShippingService : IShippingService
    {
        ...
        private const string CorreiosApiUrl = "http://ws.correios.com.br/calculador/CalcPrecoPrazo.aspx";

        public CorreiosShippingService(IHttpClientFactory httpClientFactory)
        {
        ...
        public async Task<decimal> CalculateShippingCostAsync(string originZipCode, string destinationZipCode)
        {
            ...
            var url = QueryHelpers.AddQueryString(CorreiosApiUrl, queryParams);
            ...
            throw new Exception("Não foi possível calcular o frete. A resposta da API pode ter mudado.");
        }
    }
}